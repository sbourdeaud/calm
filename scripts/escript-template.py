...
# region capture Calm variables
    ...
    username_secret = "@@{credname.secret}@@"  # this is the password for the
                                               ...
                                               # call
    api_server = "@@{endpoint_ip}@@"  # this is the IP address of the API
                                      # server
    api_server_port = "443"  # this is the TCP port used to access the API
                             # server
...
# region prepare api call
    ...
    url = "https://{}:{}{}".format(
      ...
      api_server_port,
      api_server_endpoint
      )  # this is the url which will be used to make the API call
    headers = {
...
# region make api call
    ...
    if resp.ok:
        print json.dumps(
            ...
            indent=4
        )  # this prints the content of the response
        exit(0)
    else:
